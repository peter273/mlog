...
#
# Created: Mon Mar 20 14:48:38 2017
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        #Required for icon paths
        icon_path={"new":'plus.png','delete':'cancel-2.png','addshift':'copy.png','info':'information.png','plot':'next-1.png'}
        dirname=os.path.dirname(__file__)
        icon_path={k:os.path.join(dirname,"flaticons/icons/png/{0}".format(icon_path[k])) for k in icon_path}
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(icon_path['new']), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(icon_path['delete']), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(icon_path['addshift']), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(icon_path['info']), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(icon_path['plot']), QtGui.QIcon.Normal, QtGui.QIcon.Off)
